...
import { Search, Moon, CreditCard, Sparkles, IndianRupee } from "lucide-react";
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <nav className="border-b border-zinc-800">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-2xl font-bold tracking-wide">CARDIQ</h1>
          </div>
      ...
      <section className="max-w-5xl mx-auto px-6 py-24 text-center">
        ...
        <p className="text-zinc-400 text-lg mt-8 max-w-2xl mx-auto leading-relaxed">
          Search merchants like Amazon, Swiggy, Zomato, Fuel, Travel, Shopping
          and instantly discover which card gives the best cashback, rewards,
      ...
      <div className="mt-16 max-w-4xl mx-auto space-y-6 px-6 pb-20">
          ...
          >
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
              ...
              <div>
                ...
                <p className="text-zinc-400 mt-2">{card.offerTitle}</p>
                {/* Cashback Percentage */}
              ...
              <div className="text-left md:text-right">
                ...
                <div className="flex items-center md:justify-end text-emerald-400 font-bold text-3xl">
                  ...
                  <span>{card.estimatedSavings?.toFixed(0) || 0}</span>
                </div>

                {/* SAVINGS LABEL */}

                <p className="text-zinc-500 text-sm mt-1">Estimated Savings</p>
              </div>
            </div>
        ...
        {results.length === 0 && searched && !loading && (
          <div className="text-center mt-16 text-zinc-500">
            <p className="text-2xl font-semibold">No cards found</p>

            <p className="mt-3">Try Amazon, Fuel, Travel, Shopping...</p>
          </div>
        )}
